Feature: Wikipedia search functionality
  ...
  #data driven testing is running the same test against different test data
  #this paramaterization bellow allow us to run the same scenario against different test data but we have to manually change it for example
  # Steve Jobs to Elon Musk so we do scenario out line as bellow
